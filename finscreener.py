...
def getBalanceSheet(sym):
    ...
    combStat = ((((avgAssetsGrowth - avgLiabilitiesGrowth) * 5)) + avgCashSTInvGrowth + (50 - (avgDebtRatioChange * 3))) / 3
...
def combinedStat(incomeStatement, balanceSheet):
    ...
    for x in range(len(incomeStatement)):
        ...
        finalStat = (combGrowthInc * 3 + (combGrowthBal * 2)) / 2
...
symbols2 = ['MSFT', 'AAPL', 'FB', 'AMZN', 'NFLX']
